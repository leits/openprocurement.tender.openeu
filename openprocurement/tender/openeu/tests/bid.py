...
class TenderBidderBatchDocumentWithDSResourceTest(BaseTenderContentWebTest):
    docservice = True
    initial_status = 'active.tendering'
...
def suite():
    ...
    suite.addTest(unittest.makeSuite(TenderBidderBatchDocumentWithDSResourceTest))
    return suite
